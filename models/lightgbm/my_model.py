...
class MyModel(object):
    def __init__(self):
        self.TRAIN_DATA_PATH = os.path.join(curr_dir, '../../preprocess/output/train_raw_0.csv')
        self.VALID_DATA_PATH = os.path.join(curr_dir, '../../preprocess/output/valid_raw_0.csv')
